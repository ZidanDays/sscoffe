                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="border rounded">
                            <a href="#">
                                <img src="assets/img/Espreso.jpg" class="img-fluid rounded" alt="Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h4 class="fw-bold mb-3">Espreso</h4>
                        <p class="mb-3">Category: Coffee</p>
                        ...
                        <a href="?q=cart" class="btn border border-secondary rounded-pill px-4 py-2 mb-4 text-primary btn-addto"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                    </div>
                    <div class="col-lg-12">
                        <nav>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex justify-content-between py-3 mb-5">
                                    ...
                                    <a href="#" class="btn border border-secondary text-primary rounded-pill px-4 py-3 btn-addto">
                                        Post Comment</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-4 fruite">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex justify-content-center my-4">
                            <a href="#" class="btn border border-secondary px-4 py-3 rounded-pill text-primary w-100 btn-addto">Vew
                                More</a>
                        </div>
                    </div>
                    <div class="col-lg-12">
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                <div class="border border-primary rounded position-relative vesitable-item">
                    <div class="vesitable-img">
                        <img src="assets/img/pisang goreng.jpg" class="img-fluid w-100 rounded-top" alt="">
                    </div>
                    ...
                    <div class="p-4 rounded-bottom">
                        ...
                        <div class="d-flex justify-content-between flex-lg-wrap">
                            <p class="text-dark fs-5 fw-bold mb-0">20K </p>
                            <a href="#" class="btn border border-secondary rounded-pill px-3 text-primary btn-addto"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                        </div>
                    </div>
                </div>
                <div class="border border-primary rounded position-relative vesitable-item">
                    <div class="vesitable-img">
                        <img src="assets/img/kentang goreng.jpg" class="img-fluid w-100 rounded-top" alt="">
                    </div>
                    <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">Food</div>
                    <div class="p-4 rounded-bottom">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    <div class="vesitable-img">
                        <img src="assets/img/Nasi goreng.jpg" class="img-fluid w-100 rounded-top bg-light" alt="">
                    </div>
                    <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">Food</div>
                    <div class="p-4 rounded-bottom">
                        <h4>Nasi Goreng</h4>
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    <div class="vesitable-img">
                        <img src="assets/img/Ayam geprek.jpg" class="img-fluid w-100 rounded-top" alt="">
                    </div>
                    <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">Food</div>
                    <div class="p-4 rounded-bottom">
                        <h4>Ayam Geprek</h4>
