...
<head>
    ...
    <link rel="stylesheet" href="css/stylebaru1.css">
    <!-- endinject -->
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="?q=homes">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">Homes</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?q=menu_makanan">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">Menu Minuman</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?q=menu_minuman">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">Menu Makanan</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?q=section4">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">Section 4</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?q=bestproduk">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">Best Seller</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="?q=user">
                            <i class="icon-grid menu-icon"></i>
