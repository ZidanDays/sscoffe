<div class="content-wrapper">
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title">Produk Makanan</p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#editProductModalminuman"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="?q=add_menu_minuman" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
...
<!-- Modal Edit Product -->
<div class="modal fade" id="editProductModalminuman" tabindex="-1" aria-labelledby="editProductModalLabelminuman"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form action="?q=edit_menu_minuman" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="?q=delete_menu_minuman" method="POST">
