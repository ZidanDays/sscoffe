...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($productImage)) {
        ...
        if (move_uploaded_file($productImageTmpName, $uploadPath)) {
            ...
            $sql = "INSERT INTO produk_makanan (product_name, description, price, image_url, category) VALUES ('$productName', '$productDescription', '$productPrice', '$uploadPath', '$productCategory')";
        } else {
        ...
        $sql = "INSERT INTO produk_makanan (product_name, description, price, category) VALUES ('$productName', '$productDescription', '$productPrice', '$productCategory')";
    }
