...
<body img src="image/logo/plantt.png" class="tanaman">
    <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
        <div class="container">
            <a class="navbar-brand text-success" style="font-weight: 900;" href="index.php"> <i class="fa fa-leaf mr-2 rotate-n-15"></i>
                SS CoffeShop
            </a>
        </div>
    </nav>
    ...
    <div class="container">
        <!-- <body img src="image/logo/plantt.png" width="600px" alt="DirumahAja" class="header"/> -->
        <!-- Outer Row -->
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="cek-login.php" method="post">
                                        ...
                                        <button type="submit" class="btn btn-success btn-block btn-user"><i class="fas fa-fw fa-sign-in-alt mr-1"></i> Masuk</button>
                                    </form>
                                </div>
                            </div>
                        </div>
