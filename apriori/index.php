...
<head>
  ...
  <title>Association Rule Algoritma Apriori</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">SS CoffeShop</div>
      </a>
      ...
      <li class="nav-item <?php echo ($menu_active == 'produk') ? "active" : ""; ?>">
      ...
      <!-- <li class="nav-item <?php
                          echo ($menu_active == 'bundling') ? "active" : "";
                          echo ($menu_active == 'view_rule') ? "active" : "";

                          ?>">
        <a class="nav-link" href="index.php?menu=bundling">
          <i class="fas fa-fw fa-coins"></i>
          <span>Menu Bundling</span></a>
      </li> -->

      <li class="nav-item <?php
                          echo ($menu_active == 'paket') ? "active" : "";
                          echo ($menu_active == 'view_rule') ? "active" : "";

                          ?>">
        <a class="nav-link" href="index.php?menu=paket">
          <i class="fas fa-fw fa-coins"></i>
          <span>Menu paket</span></a>
      </li>

      <li class="nav-item <?php echo ($menu_active == 'daftar_pesanan') ? "active" : ""; ?>">
        <a class="nav-link" href="index.php?menu=daftar_pesanan">
          <i class="fas fa-leaf"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a href="index.php?menu=profile" class="dropdown-item">SS Coffee</a>
        ...
        <div class="container-fluid">
          ...
          if (isset($_GET['hapusPaket'])) {
            $id_paket = $_GET['hapusPaket'];
            // $conn = mysqli_connect('localhost', 'root', '', 'dm_apriori');
            $conn = mysqli_connect('localhost', 'root', '', 'keisya_ecommerse');
            mysqli_query($conn, "DELETE FROM `paket` WHERE id='$id_paket' ");
            echo "<script>alert('Paket berhasil dihapus !');document.location.href='index.php?menu=paket';</script>";
          }
          if (isset($_GET['menu'])) {
            $menu = $_GET['menu'];
          }
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button class="btn btn-warning" type="button" data-dismiss="modal"><i class="fas fa-fw fa-times mr-1"></i>Tidak</button>
