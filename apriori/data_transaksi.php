...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-money-bill-wave"></i> Data Penjualan Tanaman</h1>
...
if (isset($_POST['submit'])) {
    ...
    for ($i = 2; $i <= $baris; $i++) {
        ...
        $produkIn = str_replace(",   ", ",", $produkIn);
        $produkIn = str_replace(",    ", ",", $produkIn);
        $sql = "INSERT INTO chechkout (order_date, product_name) VALUES ";
        $value_in = array();
...
if (isset($_POST['simpan'])) {
    ...
    // insert kedb 
    $inputTranksaksi = mysqli_query($conn, "INSERT INTO chechkout (order_date,product_name,id_bulan,tahun,jam)
...
<div class="modal fade" id="modaladd" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="post" enctype="multipart/form-data" action="">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"><i class="fas fa-fw fa-plus"></i> Tambah Data
                        Penjualan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <div class="modal-body">
                    <div class="col-12">
                        <label for="" class="font-weight-bold">Tanggal Transaksi Penjualan Tanaman</label>
                    ...
                    <div class="col-12">
                        ...
                        <!-- Options -->
                        <select name="produk[]" id="multiple" multiple>
                            <?php
                            // $conn = mysqli_connect('localhost', 'root', '', 'dm_apriori');
                            $conn = mysqli_connect('localhost', 'root', '', 'keisya_ecommerse');
                            ...
                            while ($row = mysqli_fetch_array($data)) {
                                echo '<option value="' . $row['produk'] . '">' . $row['product_name'] . '</option>';
                            }
                            ?>
                        </select>
                    </div>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            ?>
                <tr>
                    ...
                    <td class='text-center'> <?= format_date2($row['order_date']) ?></td>
