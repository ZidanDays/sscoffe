        ...
        <div class="page-content">
            ...
            ?>
                            ...
                            <form method="post" action="">
                                <div class="row">
                                    <div class="col-md">
                                        ...
                                        <div class="form-group">
                                            <input name="search_display" type="submit" value="Cari Berdasarkan Tanggal Transaksi" class="btn btn-primary">
                                        </div>
                                    </div>
                                    <!-- end -->
                                    <div class="col-md">
                                        <div class="form-group">
                                            <label>Min Support(Dukungan): </label>
                                            <input name="min_support" type="text" value="<?php echo $_POST['min_support']; ?>" class="form-control" placeholder="Nilai Min Support(Dukungan)">
                                        </div>
                                        <div class="form-group">
                                            <label>Min Confidence(Kepastian): </label>
                                            <input name="min_confidence" type="text" value="<?php echo $_POST['min_confidence']; ?>" class="form-control" placeholder="Nilai Min Confidence(Kepastian)">
                                        </div>
                ...
                <?php
                    ...
                    $sql = "SELECT COUNT(*) FROM checkout 
                            WHERE order_date BETWEEN '$start' AND '$end' ";
                            // WHERE transaction_date BETWEEN '$start' AND '$end' ";
                    $res = $db_object->db_query($sql);
                    $num = $db_object->db_fetch_array($res);
                    $minSupportRelatif = ($_POST['min_support'] / $num[0]) * 100;
                    echo "Nilai Min Support(dukungan) Relatif: " . $minSupportRelatif;
                    echo "<br>";
                    echo "Nilai Min Confidence(kepastian): " . $_POST['min_confidence'];
                    echo "<br>";
                ...
                <form method="post" action="">
                    <div class="row">
                        <div class="col-lg-6 ">
                            ...
                            <div class="form-group">
                                <input name="search_display" type="submit" value="Cari Berdasarkan Tanggal Transaksi" class="btn btn-secondary">
                            </div>
                        </div>
                        <div class="col-lg-6 ">
                            <div class="form-group">
                                <input name="min_support" type="text" class="form-control" placeholder="Nilai Min Support(Dukungan)">
                            </div>
                            <div class="form-group">
                                <input name="min_confidence" type="text" class="form-control" placeholder="Nilai Min Confidence(Kepastian)">
                            </div>
                            <div class="form-group">
                                <input name="submit" type="submit" value="Proses" class="btn btn-success">
                            </div>
