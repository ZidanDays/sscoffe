...
<head>
	...
	<title>Tracking - Rima Arhyan</title>
</head>
<body class="bg-light">
	...
	<div class="nav-scroller bg-white shadow-sm">
		<div class="container-fluid pt-2 pb-2">
			<a href="./">Halaman Utama</a> > Tracking Produk
		</div>
	</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="col-sm-12 col-lg-6">
					<div class="alert alert-warning alert-dismissible fade show" role="alert">
						<strong>Selamat!</strong> Produk pesanan Anda sedang dalam proses pengiriman.
					...
					<center class="mt-5 mb-2">
						<div class="h5 b text-website">
							Tracking Produk Pesanan
						</div>
						<div class="b text-website">
							No. Pesanan : 23432422342
						</div>
					</center>
					<div class="table-responsive">
						<table class="table table-bordered mb-0">
							...
							<tbody>
								<tr>
									<td>17 Juni 2019</td>
									<td>Paket pesanan akan dikirim ke JNE</td>
								</tr>
							</tbody>
						</table>
					</div>
					<center>					
						<a href="pemesanan.html">
							<button class="btn bg-website text-white btn-sm mt-3">Kembali ke Pemesanan</button>
						</a>
					</center>
				</div>
			</div>
